...
def tads_reward_webhook(
    ...
    # TADS widget 11416 historically posts to this URL.  Settle an active
    # Penalty Duel session first so deployments remain safe while the TADS
    # cabinet webhook is migrated to /penalty-duel/rewards/tads/webhook.
    try:
