...
from app.models.arena_promocode import ArenaTicketPromocode, ArenaTicketPromocodeClaim
...
class ArenaPromocodeService:
    ...
    def claim(self, telegram_id: int, raw_code: str) -> dict:
        ...
        self.db.add(claim)
        wallet.tournament_tickets = int(wallet.tournament_tickets or 0) + promo.ticket_amount
        promo.usage_count += 1
