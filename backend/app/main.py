...
from app.routers.arena_v5 import (
...
tournament_worker = TournamentWorker(SessionLocal)
app = FastAPI(
...
def start_campaign_worker():
    ...
    if TOURNAMENT_WORKER_ENABLED:
        tournament_worker.start()
